...
(function () {
  ...
  const i18n = {
    en: {
      ...
      pickActivityLead: 'Select an activity package or whole park · max 6 people online',
    ...
    hr: {
      ...
      pickActivityLead: 'Odaberite paket aktivnosti ili cijeli park · max 6 osoba online',
