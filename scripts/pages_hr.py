...
HOME = {
    ...
    "meta_description": (
        ...
        'Pozovite +385 98 224 314 ili rezervirajte online do 10 osoba.'
    ),
    "keywords": (
...
PAGES = [{'slug': 'sto-raditi-u-istri',
  ...
  'related': [{'slug': 'avanturisticki-park-hrvatska',
               ...
               'desc': 'Osam glavnih atrakcija u Glavani Parku'},
              ...
              {'slug': 'avanturisticki-park-hrvatska',
               ...
               'desc': 'Zašto je Glavani Park vrhunska adrenalinska destinacija'},
 ...
 {'slug': 'avanturisticki-park-hrvatska',
  ...
  'meta_description': 'Usporedite avanturističke parkove u Hrvatskoj — Glavani Park '
                      'Istria nudi 1,5 ha visokih staza, zipline i ljudsku katapultu '
                      'kod Pule. Otvoreno 9–17 h. Rezervacije: +385 91 896 4525.',
  'keywords': 'avanturistički park Hrvatska, adrenalinski park Istria, najbolji '
              'avanturistički park Hrvatska, visoke staze Hrvatska, Glavani Park, '
              'avantura na otvorenom Hrvatska',
  'hero_badge': '1,5 hektara · među najvećim adrenalinskim parkovima',
  'hero_subtitle': 'Od dalmatinske obale do istarske šume Hrvatska nudi avanturu na '
                   'otvorenom — a Glavani Park kod Barbana spada među najveće i '
                   'najbolje opremljene adrenalinske parkove u zemlji.',
  'image': 'glavani-park-adventure-istria-croatia.jpg',
  'image_alt': 'Glavani Park — vodeći avanturistički park u Hrvatskoj, smješten u '
               'Istri',
  'sections': [{'h2': 'Uspon avanturističkog turizma u Hrvatskoj',
                'paragraphs': ['<p>Hrvatski turistički brend dugo je počivao na '
                               'Jadranu — zidinama Dubrovnika, noćnom životu Hvara, '
                               'slapovima Plitvica. Posljednjih desetljeća '
                               'avanturistički parkovi uz obalu i u unutrašnjosti '
                               'dodali su sloj strukturiranih aktivnosti s '
                               'profesionalnom sigurnošću — privlačnih obiteljima, '
                               'školama i korporativnim timovima koji traže više od '
                               'pasivnog razgledavanja.</p>',
                               '<p>Parkovi diljem Hrvatske razlikuju se po veličini. '
                               'Neki operatori vode jedan zipline ili kompaktan krug '
                               'sezonski. Drugi, poput <strong>Glavani Parka</strong> '
                               'u Istri, ulažu u višeatrakcijske lokacije s dnevnim '
                               'radom, bilingvalnim osobljem i opremom provjeranom '
                               'prema europskim standardima. Pri odabiru '
                               '<strong>avanturističkog parka u Hrvatskoj</strong> '
                               'razmotrite površinu, raznolikost, kvalifikacije '
                               'instruktora i je li sve uključeno u jednu ulaznicu ili '
                               'se naplaćuje odvojeno.</p>',
                               '<p>Usporedba avanturističkih parkova u Hrvatskoj '
                               'uključuje kriterije poput broja atrakcija, dnevnog '
                               'rada, jezične podrške, parkinga i blizine turističkih '
                               'baza. Glavani Park ispunjava sve za istarski segment '
                               'tržišta: nema potrebe za cjelodnevnom vožnjom iz Pule, '
                               'nema skrivenih doplate po atrakciji u standardnoj '
                               'ulaznici, a instruktori su prisutni na svakoj stanici '
                               'bez „samoposlužnog“ penjanja.</p>']},
               {'h2': 'Čime se Glavani Park razlikuje',
                'paragraphs': ['<p>Glavani Park pokriva <strong>1,5 hektara</strong> '
                               'hrastove šume između <strong>Barbana</strong> i '
                               '<strong>Vodnjanja</strong>, otprilike trideset minuta '
                               'od <strong>Pule</strong>. Ta površina omogućuje '
                               'istovremeni rad više atrakcija bez osjećaja gužve. '
                               'Ponuda spada među najopsežnije u zemlji:</p>',
                               '<p><strong>Visoke staze:</strong> Tri certificirana '
                               'kruga na 2 m (žuta, obiteljska), 6 m (plava, sa '
                               'ziplineom 113 m) i 10 m (crna, napredna). Kontinuirani '
                               'osigurač drži sudionike povezanima.</p>',
                               '<p><strong>Zipline:</strong> Samostalna linija 120 m '
                               'do 20 m visine plus zipline u plavom krugu. Detalje '
                               'potražite u vodiču <a '
                               'href="/hr/zipline-hrvatska/">zipline Hrvatska</a>.</p>',
                               '<p><strong>Signature vožnje:</strong> Ljuljačka 12,5 '
                               'm, ljudska katapulta (0–100 km/h u sekundi), Quick '
                               'Jump s kontroliranim padom s 20 m i vanjski zid za '
                               'penjanje.</p>',
                               '<p>Za razliku od parkova s jednim adrenalinom, Glavani '
                               'Park omogućuje napredak od nježne žute staze do '
                               'ekstremne katapulte u jednom posjetu — idealno za '
                               'mješovite obitelji i raznolike korporativne grupe.</p>',
                               '<p>Hrvatska turistička strategija sve više naglašava '
                               'održivi i raznoliki turizam izvan obale — '
                               'avanturistički parkovi doprinose tom cilju privlačeći '
                               'goste u unutrašnjost poluotoka i podržavaju lokalnu '
                               'ekonomiju Barbana i Vodnjanja. Posjet Glavani Parku '
                               'često uključuje potrošnju u lokalnim konobama i kupnju '
                               'istarskih proizvoda po povratku.</p>']},
               {'h2': 'Prednost lokacije u Istri',
                'paragraphs': ['<p>Geografija je važna. Glavani Park leži u južnoj '
                               'središnjoj Istri — oko trideset minuta od Pule, '
                               'četrdeset pet od Rovinja, manje od sat vremena od '
                               'mnogih vila u unutrašnjosti. Besplatno parkiranje, '
                               'osvježenja i osjenčani piknik podržavaju cjelodnevne '
                               'posjete. Radno vrijeme <strong>9–17 h</strong>, '
                               'posljednji ulaz <strong>15 h</strong>.</p>',
                               '<p>Park je naveden kod Turističke zajednice Istre i '
                               'privlači međunarodne posjetitelje cijele sezone. '
                               'Instruktori na engleskom smanjuju jezične barijere za '
                               'goste s pulskog aerodroma — praktična prednost u '
                               'odnosu na udaljene dalmatinske parkove s dužim '
                               'transferima iz Splita ili Dubrovnika.</p>',
                               '<p>Obližnji Barban i Vodnjan nude kulturna '
                               'zaustavljanja prije ili poslije posjeta, dok obala '
                               'ostaje dostupna za kombinaciju avanture i plaže. Za '
                               'putnike iz Pule pogledajte <a '
                               'href="/hr/sto-raditi-kod-pule/">što raditi kod '
                               'Pule</a>.</p>',
                               '<p>Ako ste već posjetili manje parkove u Dalmaciji ili '
                               'na otocima, razlika u opsegu Glavani Parka postaje '
                               'očita u prvih sat vremena — više staza, više '
                               'ekstremnih elemenata i više prostora za pauze. To ga '
                               'čini prioritetnom destinacijom za putnike koji traže '
                               '„glavni“ adrenalinski dan na hrvatskom odmoru, a ne '
                               'kratku zabavnu stanicu uz cestu.</p>']},
               {'h2': 'Grupe, događaji i ponovni posjeti',
                'paragraphs': ['<p>Glavani Park nije samo turistička atrakcija već i '
                               'venue događaja. <a '
                               'href="/hr/team-building-istri/">Korporativni team '
                               'building</a>, <a '
                               'href="/hr/skolski-izleti-istri/">školski izleti</a> i '
                               '<a href="/hr/rodjendanske-zabave-istri/">rođendanske '
                               'zabave</a> čine značajan udio rezervacija. Prilagođeni '
                               'paketi uključuju dedicirano vrijeme instruktora i '
                               'rezervirana područja — kontakt <a '
                               'href="tel:+385918964525">+385 91 896 4525</a>.</p>',
                               '<p>Pojedinci često se vraćaju tijekom tjedna odmora: '
                               'prvo žuta i plava staza s djecom, zatim crna staza i '
                               'ekstremne atrakcije kad raste samopouzdanje. Pitajte '
                               'za sezonske ponude pri pozivu za trenutne '
                               'cijene.</p>']},
               {'h2': 'Planirajte posjet vodećem istarskom avanturističkom parku',
                'paragraphs': ['<p>Bilo da uspoređujete parkove nacionalno ili imate '
                               'smještaj u Istri, Glavani Park zaslužuje mjesto u '
                               'itineraru. Pregledajte <a '
                               'href="/hr/sigurnost/">sigurnosne certifikate</a>, <a '
                               'href="/hr/avanturisticki-park-hrvatska/">smjernice za '
                               'obitelji</a> i nazovite unaprijed za dostupnost.</p>',
                               '<p>Adresa: Glavani 10, 52207 Barban, Istria, Hrvatska. '
                               'Telefon: +385 91 896 4525 (engleski), +385 98 224 314 '
                               '(hrvatski). Dođite prije podneva za puni doživljaj; '
                               'planirajte minimum tri do četiri sata. Jadran privlači '
                               'prema obali — ali istarska krošnja u Glavani Parku '
                               'donosi adrenalin koji najdulje pamtite.</p>',
                               '<p>Glavani Park redovito prima međunarodne '
                               'posjetitelje iz Austrije, Njemačke, Italije i '
                               'Slovenije — potvrda da se istarski park smatra '
                               'vrhunskom destinacijom u širem kontekstu avanture u '
                               'Hrvatskoj. Recenzije ističu omjer cijene i kvalitete u '
                               'odnosu na manje parkove s manje atrakcija. Ako ste u '
                               'dilemi između dana na brodu i dana u šumi, Glavani '
                               'Park nudi dovoljno sadržaja da opravda cjelodnevni '
                               'izlet bez osjećaja da ste platili ulaznicu za samo '
                               'jednu vožnju.</p>',
                               '<p>Kada uspoređujete avanturističke parkove, obratite '
                               'pažnju na broj instruktora po posjetitelju u vrhu '
                               'sezone — Glavani Park održava nadzor na svakoj stanici '
                               'umjesto samostalnog kretanja po stazama bez nadzora. '
                               'To je ključna razlika u stvarnoj sigurnosti, ne samo u '
                               'marketingu. Naša lokacija u Barbanu podržava lokalnu '
                               'zajednicu kroz sezonske instruktore i suradnju s '
                               'istarskim turističkim akterima.</p><p>Plan putovanja '
                               'kroz Hrvatsku s jednom glavnom avanturističkom '
                               'stanicom u Istri jednostavniji je s parkom koji nudi '
                               'pun spektar atrakcija na jednoj lokaciji — bez vožnje '
                               'između odvojenih zipline, penjanja i staza u '
                               'različitim mjestima.</p>']}],
  'faqs': [{'q': 'Je li Glavani Park najveći avanturistički park u Hrvatskoj?',
            'a': 'Glavani Park spada među najveće namjenske adrenalinske parkove u '
                 'Hrvatskoj na 1,5 hektara, s jednom od najšire ponude — visoke staze, '
                 'dual zipline, katapulta i Quick Jump kod Pule.'},
           {'q': 'Kako se uspoređuje s dalmatinskim parkovima?',
            'a': 'Lokacija u Istri odgovara gostima u Puli, Rovinju i središnjoj Istri '
                 's kraćom vožnjom. Raznolikost atrakcija i tim na engleskom ključni '
                 'su razlikovni faktori.'},
           {'q': 'Koje je radno vrijeme?',
            'a': 'Tijekom sezone otvoreno 9–17 h svaki dan. Posljednji ulaz u 15 h. '
                 'Nazovite +385 91 896 4525 za potvrdu datuma i grupne rezervacije.'},
           {'q': 'Je li oprema uključena u ulaznicu?',
            'a': 'Da. Harnes, kacige i nadzor instruktora uključeni su. Nosite '
                 'zatvorene sportske cipele; izbjegavajte sandale i labavi nakit.'}],
  'related': [{'slug': 'zipline-hrvatska',
               'title': 'Zipline Hrvatska',
               'desc': '120-metarski letovi i linije u stazama'},
              {'slug': 'sto-raditi-u-istri',
               'title': 'Što raditi u Istri',
               'desc': 'Uključite avanturu u cjelokupan izlet'},
              {'slug': 'avanturisticki-park-hrvatska',
               'title': 'Naše aktivnosti',
               'desc': 'Staze za djecu, tinejdžere i roditelje'},
              {'slug': 'sigurnost',
               'title': 'Sigurnost i oprema',
               'desc': 'CE certificirana oprema i dnevne provjere'}]},
 {'slug': 'sigurnost',
