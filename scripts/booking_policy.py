...
BOOKING_POLICY = {
    "en": {
        ...
        "faq_answer": (
            ...
            "From the start of July through the end of September, walk-ins are welcome, subject to availability. "
        ...
        "activity_answer": (
            ...
            "From July through the end of September, walk-ins may be accepted "
        ...
        "home_notice": (
            ...
            "Walk-ins may be accepted in peak season (July–September), subject to availability."
        ),
        "book_page": (
            "<strong>Booking policy:</strong> From the end of September until the start of July, all visits require "
            "advance booking; walk-ins are not accepted. Walk-ins may be accepted from July through the end of "
        ...
        "summary_paragraph": (
            ...
            "walk-ins are not accepted. From July through the end of September, walk-ins are welcome, "
    ...
    "hr": {
        ...
        "faq_answer": (
            ...
            "Od početka srpnja do kraja rujna dolazak bez rezervacije moguć je, ovisno o dostupnosti. "
        ...
        "home_notice": (
            ...
            "Dolazak bez rezervacije moguć je u vrhu sezone (srpanj–rujan), ovisno o dostupnosti."
        ),
        "book_page": (
            "<strong>Pravila rezervacije:</strong> od kraja rujna do početka srpnja svi posjeti zahtijevaju "
            "unaprijednu rezervaciju; dolazak bez rezervacije nije moguć. Dolazak bez rezervacije moguć je od "
            "srpnja do kraja rujna, ovisno o dostupnosti."
        ),
