...
BOOKING_POLICY = {
    "en": {
        ...
        "faq_answer": (
            ...
            "From the start of July through the end of September, walk-ins are welcome on "
            "<strong>weekdays only</strong> (Monday–Friday), subject to availability. "
        ...
        "activity_answer": (
            ...
            "From July through the end of September, walk-ins may be accepted on weekdays only "
        ...
        "home_notice": (
            ...
            "booked in advance — no walk-ins. Weekday walk-ins may be accepted in peak season (July–September) only."
        ),
        "book_page": (
            "<strong>Booking policy:</strong> Saturdays are pre-booking only — no walk-ins. From the end of September "
            "until the start of July, all visits require advance booking; walk-ins are not accepted. Weekday walk-ins "
        ...
        "summary_paragraph": (
            ...
            "walk-ins are not accepted. From July through the end of September, walk-ins are welcome on weekdays only, "
    ...
    "hr": {
        ...
        "faq_answer": (
            ...
            "Od početka srpnja do kraja rujna dolazak bez rezervacije moguć je samo "
            "<strong>radnim danom</strong> (ponedjeljak–petak), ovisno o dostupnosti. "
        ...
        "activity_answer": (
            ...
            "Od srpnja do kraja rujna dolazak bez rezervacije moguć je samo radnim danom "
        ...
        "home_notice": (
            ...
            "biti rezervirani — bez dolaska bez najave. Dolazak bez rezervacije moguć je samo radnim danom u vrhu sezone "
            "(srpanj–rujan)."
        ),
        "book_page": (
            ...
            "moguć. Dolazak bez rezervacije moguć je radnim danom od srpnja do kraja rujna, ovisno o dostupnosti."
        ),
        ...
        "summary_paragraph": (
            ...
            "Od <strong>kraja rujna do početka srpnja</strong> svi posjeti moraju biti unaprijed rezervirani; "
            "dolazak bez rezervacije nije moguć. Od srpnja do kraja rujna dolazak bez rezervacije moguć je samo radnim "
            "danom, ovisno o dostupnosti. Instruktori govore hrvatski i engleski."
        ),
    },
}
