...
GOOGLE_REVIEWS: list[dict] = [
    {
        ...
        "en": (
            ...
            "all of the activities, and give yourself at least 4 hours on the park to do so."
        ),
        "hr": (
            ...
            "Čak nam je ljubazno ponudio prijevoz. Park je bio pun zabave, probali smo sve aktivnosti i nisu "
            "razočarale. Ljudska katapulta je bila nevjerojatna — tako brza i zabavna! Prepreke su bile "
            "izazovne, ali na prikladnoj visini za djecu i odrasle. Preporučujem sve aktivnosti i barem "
            "četiri sata u parku."
        ),
    },
    {
        ...
        "en": (
            ...
            "Nigel and his crew will accompany you all the way so you are not doing this alone."
        ),
        "hr": (
    ...
    },
    {
        ...
        "en": (
            "We paid for all of the games and rides, and I would recommend anyone who visits to do the same! "
            "The park boasts a perfect mixture of an adrenaline and calm. The climbing parts of the park are "
            "structured that the level of difficulty gradually increases, allowing for anyone who tackles it "
            "to get a feel for the equipment and prepares them for the more intense and challenging parts! "
            "And by golly are they intense! The zip-line (arguably the best in pula) and the catapult were "
            "insane! However the day was made perfect by the personalities of the staff at the park."
        ),
        "hr": (
            "Platili smo sve igre i vožnje — svakome preporučujem isto! Park nudi savršen spoj adrenalina "
            "i mira. Dijelovi s penjanjem grade se postupno — težina raste, upoznajete opremu i pripremite "
            "se za intenzivnije dijelove! A intenzivni su! Zipline (vjerojatno najbolji kod Pule) i katapult "
            "bili su nevjerojatni! Dan su upotpunili ljubaznost i humor osoblja."
        ),
    },
    {
        "author": "Michal Pysny",
    ...
    },
    {
        ...
        "hr": (
            ...
            "što ste mi pomogli pronaći mobitel — posjet je bio posebna avantura. Savjet za odmor: "
            "definitivno dođite i uživajte u danu."
        ),
    },
]
