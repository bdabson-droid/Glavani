...
PAGES = [{'slug': 'things-to-do-in-istria',
  ...
  'related': [{'slug': 'adventure-park-croatia',
               ...
               'desc': 'Eight signature attractions at Glavani Park'},
              ...
              {'slug': 'adventure-park-croatia',
               ...
               'desc': 'Why Glavani Park is a top-rated adrenaline destination'},
 ...
 {'slug': 'adventure-park-croatia',
  ...
  'meta_description': 'Compare adventure parks in Croatia — Glavani Park Istria offers '
                      '1.5 ha of high ropes, ziplines & Human Catapult near Pula. Open '
                      '9–5. Book: +385 91 896 4525.',
  'keywords': 'adventure park Croatia, adrenaline park Istria, best adventure park '
              'Croatia, high ropes Croatia, Glavani Park, outdoor adventure Croatia, '
              'theme park Istria',
  'hero_badge': "1.5 Hectares · Croatia's Largest Adrenaline Parks",
  'hero_subtitle': 'From Dalmatian coastlines to Istrian forest, Croatia offers '
                   'outdoor adventure — and Glavani Park near Barban ranks among the '
                   'biggest and best-equipped adrenaline parks in the country.',
  'image': 'glavani-park-adventure-istria-croatia.jpg',
  'image_alt': 'Glavani Park — one of the leading adventure parks in Croatia, located '
               'in Istria',
  'sections': [{'h2': 'The Rise of Adventure Tourism in Croatia',
                'paragraphs': ["<p>Croatia's tourism brand has long rested on the "
                               "Adriatic — Dubrovnik's walls, Hvar's nightlife, "
                               "Plitvice's waterfalls. Over the past decade, inland "
                               'and coastal-adjacent adventure parks have added a '
                               'complementary layer: structured outdoor activities '
                               'with professional safety systems that appeal to '
                               'families, school groups, and corporate teams seeking '
                               'more than passive sightseeing.</p>',
                               '<p>Adventure parks across Croatia vary widely in '
                               'scale. Some operators run a single zipline or a '
                               'compact ropes course seasonally. Others, like '
                               '<strong>Glavani Park</strong> in Istria, invest in '
                               'multi-attraction sites with daily operations, '
                               'bilingual staff, and equipment inspected to European '
                               'standards. When evaluating an <strong>adventure park '
                               'in Croatia</strong>, consider footprint, variety, '
                               'instructor credentials, and whether attractions are '
                               'included in a single admission or sold '
                               'piecemeal.</p>']},
               {'h2': 'What Makes Glavani Park Different',
                'paragraphs': ['<p>Glavani Park covers <strong>1.5 hectares</strong> '
                               'of oak forest between <strong>Barban</strong> and '
                               '<strong>Vodnjan</strong>, roughly 30 minutes from '
                               '<strong>Pula</strong>. That scale allows simultaneous '
                               'operation of multiple attractions without the cramped '
                               'feel of smaller installations. The activity line-up is '
                               'among the most comprehensive in the country:</p>',
                               '<p><strong>High-ropes courses:</strong> Three '
                               'certified routes at 2 m (yellow, family-friendly), 6 m '
                               '(blue, with 113 m zipline), and 10 m (black, '
                               'advanced). Continuous belay keeps participants '
                               'connected throughout.</p>',
                               '<p><strong>Ziplines:</strong> Standalone 120-metre '
                               'line up to 20 m high, plus the integrated blue-route '
                               'zipline. See our dedicated <a '
                               'href="/en/zipline-croatia/">zipline Croatia guide</a> '
                               'for details.</p>',
                               '<p><strong>Signature rides:</strong> 12.5-metre high '
                               'swing, Human Catapult (0–100 km/h in one second), '
                               '20-metre Quick Jump controlled free fall, and an '
                               'outdoor climbing wall for all skill levels.</p>',
                               '<p>Unlike parks that specialise in a single thrill, '
                               'Glavani Park lets visitors progress from gentle '
                               'yellow-route challenges to extreme catapult launches '
                               'in one visit — making it suitable for mixed-age '
                               'families and diverse corporate groups.</p>']},
               {'h2': 'Location Advantage in Istria',
                'paragraphs': ['<p>Geography matters. Glavani Park sits in central '
                               'southern Istria with drive times of approximately 30 '
                               'minutes from Pula, 45 from Rovinj, and under an hour '
                               'from many inland villa rentals. Free parking, on-site '
                               'refreshments, and a shaded picnic area support '
                               'full-day visits. Opening hours are daily <strong>9 '
                               'AM–5 PM</strong> with last entry at <strong>3 '
                               'PM</strong>.</p>',
                               '<p>The park is listed by the Istria Tourist Board as a '
                               'recommended outdoor attraction and draws international '
                               'visitors throughout the season. English-speaking '
                               'instructors reduce language barriers for guests flying '
                               'into Pula airport — a practical advantage over remote '
                               'Dalmatian parks requiring longer transfers from Split '
                               'or Dubrovnik.</p>',
                               '<p>Nearby towns Barban and Vodnjan offer cultural '
                               'stops before or after your visit, while the coast '
                               'remains accessible for combined adventure-beach '
                               'holidays. For Pula-based travellers, see <a '
                               'href="/en/things-to-do-near-pula/">things to do near '
                               'Pula</a>.</p>']},
               {'h2': 'Groups, Events, and Repeat Visits',
                'paragraphs': ['<p>Glavani Park is not only a tourist attraction but '
                               'an events venue. <a '
                               'href="/en/team-building-istria/">Corporate team '
                               'building</a>, <a '
                               'href="/en/school-trips-istria/">school excursions</a>, '
                               'and <a href="/en/birthday-parties-istria/">birthday '
                               'parties</a> account for a significant share of group '
                               'bookings. Custom packages include dedicated instructor '
                               'time and reserved areas — contact <a '
                               'href="tel:+385918964525">+385 91 896 4525</a> for '
                               'planning.</p>',
                               '<p>Individual visitors often return across a holiday '
                               'week: first tackling the yellow and blue routes with '
                               'children, then returning for black route and extreme '
                               'attractions when confidence grows. Season passes or '
                               'repeat-visit discounts may be available — ask when '
                               'calling for current pricing.</p>',
                               '<p>International guests flying into Pula airport '
                               'appreciate that Glavani Park requires no ferry '
                               'connections or multi-hour transfers — a '
                               'straightforward inland drive through Istrian '
                               'countryside. That accessibility, combined with '
                               'English-speaking staff and transparent <a '
                               'href="/en/safety/">safety information</a>, explains '
                               'why the park appears on so many "best of Croatia '
                               'adventure" shortlists compiled by travel media each '
                               'spring.</p>']},
               {'h2': "Plan Your Visit to Croatia's Premier Istrian Adventure Park",
                'paragraphs': ['<p>Whether you are comparing adventure parks '
                               'nationally or already booked accommodation in Istria, '
                               'Glavani Park deserves a slot in your itinerary. Review '
                               '<a href="/en/safety/">safety certifications and '
                               'procedures</a>, check <a '
                               'href="/en/adventure-park-croatia/">family activity '
                               'guidance</a>, and call ahead to confirm availability '
                               'during your travel dates.</p>',
                               '<p>Address: Glavani 10, 52207 Barban, Istria, Croatia. '
                               'Phone: +385 91 896 4525 (English). Arrive before '
                               'midday for the fullest experience; allow three to four '
                               "hours minimum. Croatia's Adriatic may draw you to the "
                               "coast — but Istria's forest canopy at Glavani Park "
                               'delivers the adrenaline highlight you will remember '
                               'longest.</p>',
                               '<p>Visitor reviews consistently cite the '
                               'professionalism of instructors and the variety of '
                               'attractions as reasons to choose Glavani Park over '
                               'smaller ropes installations elsewhere in the country. '
                               'If you are researching <a href="/en/safety/">safety '
                               'standards</a> before committing, you will find '
                               'transparent information on CE-certified equipment, '
                               'daily inspections, and continuous belay systems — the '
                               'same details that earn recommendations from the Istria '
                               'Tourist Board and returning family guests each '
                               'season.</p>']}],
  'faqs': [{'q': 'Is Glavani Park the biggest adventure park in Croatia?',
            'a': 'Glavani Park is among the largest dedicated adrenaline parks in '
                 'Croatia at 1.5 hectares, with one of the broadest multi-attraction '
                 'line-ups including high ropes, dual ziplines, Human Catapult, and '
                 'Quick Jump near Pula.'},
           {'q': 'How does Glavani Park compare to Dalmatian adventure parks?',
            'a': "Glavani Park's Istria location suits visitors based in Pula, Rovinj, "
                 'and central Istria with shorter drives than most Dalmatian '
                 'alternatives. The attraction variety and English-speaking staff are '
                 'key differentiators.'},
           {'q': 'What are the opening hours?',
            'a': 'Open daily 9 AM–5 PM during the season. Last entry is 3 PM. Call '
                 '+385 91 896 4525 to confirm seasonal dates and book groups.'},
           {'q': 'Is equipment included in admission?',
            'a': 'Yes. Harnesses, helmets, and instructor supervision are included. '
                 'Wear closed-toe sports shoes; avoid sandals and loose jewellery.'}],
  'related': [{'slug': 'zipline-croatia',
               'title': 'Zipline Croatia',
               'desc': '120-metre flights and course-integrated lines'},
              {'slug': 'things-to-do-in-istria',
               'title': 'Things to Do in Istria',
               'desc': 'Plan adventure within a full Istria trip'},
              {'slug': 'adventure-park-croatia',
               'title': 'Our Activities',
               'desc': 'Routes for children, teens, and parents'},
              {'slug': 'safety',
               'title': 'Safety & Equipment',
               'desc': 'CE-certified gear and daily checks'}]},
 {'slug': 'safety',
